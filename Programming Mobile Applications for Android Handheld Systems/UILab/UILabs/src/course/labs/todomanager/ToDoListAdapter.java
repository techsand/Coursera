...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final TextView priorityDisp = (TextView) itemLayout.findViewById(R.id.priorityView);
		priorityDisp.setText(toDoItem.getPriority().toString());

		
		// DONE - Display Time and Date. 
		// Hint - use ToDoItem.FORMAT.format(toDoItem.getDate()) to get date and time String

		final TextView dateDisp = (TextView) itemLayout.findViewById(R.id.dateView);
		dateDisp.setText(ToDoItem.FORMAT.format(toDoItem.getDate()));
